...
import view.dto.LottosDTO.SingleLottoDTO;
import view.dto.ResultDTO;
import view.dto.ResultDTO.WinningStatDTO;
...
public class OutputView {
    ...
    public String generatePrizeDetail(WinningStatDTO prizeDTO) {
        String bonusComment = " ";
        if (prizeDTO.isBonus()) {
    ...
    public void appendStringBuilder(SingleLottoDTO lottoDTO, CustomStringBuilder stringBuilder) {
