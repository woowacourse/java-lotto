...
public class OutputView {
    ...
    public void printLottos(LottosResponse lottosDto) {
        lottosDto.lottoResponses().forEach(this::printLotto);
    }

    public void printWinningStatistic(ResultResponse lottosResult) {
