...
public class LottoTicketOutputView implements OutputView<List<LottoTicketDto>> {
    ...
    @Override
    public void printOutputData(final List<LottoTicketDto> lottoTickets) {
    ...
    private String toLottoTicketPrintForm(final LottoTicketDto lottoTicket) {
        return RIGHT_LIST_COVER + joiningLottoNumbers(lottoTicket) + LEFT_LIST_COVER;
    }

    private String joiningLottoNumbers(final LottoTicketDto lottoTicket) {
