...
public enum ErrorMessage {
    ...
    RANGE_ERROR("1과 45 사이의 수를 입력하세요."),
    NUMBER_FORMAT_ERROR("당첨 번호는 숫자를 입력해야 합니다."),
    ...
    NUMBER_LENGTH_ERROR("6자리를 입력하세요."),
    PURCHASE_FORMAT_ERROR("구입금액은 숫자여야 합니다."),
    PURCHASE_UNIT_ERROR("구입금액은 천원 단위여야 합니다."),
    PURCHASE_MINIMUM_ERROR("구입금액은 천원부터입니다."),
    PURCHASE_MAXIMUM_ERROR("10만원까지 구매 가능합니다.");
