...
public class WinningLotto {
    ...
    private static final String EMPTY_BONUS_MSG = "로또 번호가 입력되지 않았습니다.";
    ...
    private void validateEmpty(Lotto lotto, LottoNumber bonusNumber) {
        if (lotto == null) {
            throw new NullPointerException(EMPTY_LOTTO_MSG);
        }
        if (bonusNumber == null) {
            throw new NullPointerException(EMPTY_BONUS_MSG);
        }
    }
