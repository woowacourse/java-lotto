...
public class LottoTicket {
    ...
    private static final String NUMBER_OUT_OF_RANGE_ERROR_MESSAGE = String.format("%d개를 입력해주세요. ",
            LOTTO_TICKET_SIZE);
    private static final String LOTTO_TICKET_EMPTY_ERROR_MESSAGE = "로또 티켓에 로또볼이 비었습니다. 다시 드리겠습니다.";
