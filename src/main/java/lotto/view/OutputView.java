...
public class OutputView {
    ...
    public static void printStatistics(Statistics statistics) {
        ...
        statistics.ranksStatistics().forEach((rank, reward) -> System.out.printf(RESULT_MESSAGE, rank.getCountOfMatch(), rank.getReward(), reward));
        System.out.println(statistics.returnOfRate());
    }
}
