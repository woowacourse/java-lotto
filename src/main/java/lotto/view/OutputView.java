...
import lotto.controller.AccountingManager;
...
public class OutputView {
    ...
    private static void showEarningRate(Money money, List<Rank> ranks) {
        System.out.printf(EARNING_RATE_MESSAGE, AccountingManager.calculateEarningRate(money, ranks));
    }

    private static void showStatistics(List<Rank> ranks) {
