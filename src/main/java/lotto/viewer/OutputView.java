...
public class OutputView {
    ...
    public void printLottoStatistics(Map<String, Integer> statistics, double profitRate) {
        ...
        System.out.printf(FOURTH_RANK + System.lineSeparator(), statistics.get("FIFTH"));
        System.out.printf(THIRD_RANK + System.lineSeparator(), statistics.get("FIFTH"));
        System.out.printf(SECOND_RANK + System.lineSeparator(), statistics.get("FIFTH"));
        System.out.printf(FIRST_RANK + System.lineSeparator(), statistics.get("FIFTH"));
