...
public enum ExceptionHandler {
    ...
    INVALID_LOTTO_MONEY_FORMAT("로또 구입 금액은 숫자여야 합니다."),
    ...
    INVALID_LOTTO_NUMBER_SIZE(String.format("로또 번호의 개수는 %d개여야 합니다.", LOTTO_NUMBER_SIZE)),
    INVALID_LOTTO_NUMBER_RANGE(
            String.format("로또 번호가 %d - %d의 범위여야 합니다.", LOTTO_NUMBER_MIN_RANGE, LOTTO_NUMBER_MAX_RANGE)),

    INVALID_BONUS_NUMBER_FORMAT("보너스 번호는 숫자여야 합니다."),
    INVALID_BONUS_NUMBER_DISTINCT(String.format("보너스 번호가 당첨 번호 %d개와 중복되지 않아야 합니다.", LOTTO_NUMBER_SIZE));
