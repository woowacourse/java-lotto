...
public class LottoPurchaseCount {
    ...
    private static final String ERROR_MESSAGE_LOTTO_COUNT = "로또의 갯수는 음수일 수 없습니다.";
    ...
    public LottoPurchaseCount(int manualCount, int automaticCount) {
        ...
        validateCountRange(automaticCount);
        this.manualCount = manualCount;
        this.automaticCount = automaticCount;
    }

    private void validateCountRange(int value) {
        if (value < MINIMUM_VALUE) {
            throw new IllegalArgumentException(ERROR_MESSAGE_LOTTO_COUNT);
        }
    }
