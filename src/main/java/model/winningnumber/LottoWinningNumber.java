...
public class LottoWinningNumber {
	private static final String WINNING_NUMBER_RANGE_ERROR_MESSAGE = "[Error]: 당첨 번호는 %d~%d 숫자여야 합니다.";
	private static final String WINNING_NUMBER_SIZE_ERROR_MESSAGE = "[Error]: 당첨 번호는 %d개의 숫자여야 합니다.";
	...
	public LottoWinningNumber(List<Integer> numbers) {
		...
		LottoNumber.validateSize(numbers, WINNING_NUMBER_SIZE_ERROR_MESSAGE);
