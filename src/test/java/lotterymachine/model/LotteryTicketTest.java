...
class LotteryTicketTest {
    ...
    void countMatchingNumbers(String winningNumbers, int expected) {
        LotteryTicket lotteryTicket = new LotteryTicket(Ball.getBalls(Arrays.asList(7, 8, 9, 10, 11, 12)));
        LotteryTicket winningTicket = new LotteryTicket(Ball.getBalls(
    ...
    void matchBonusNumber(int bonusNumber, boolean expected) {
        LotteryTicket lotteryTicket = new LotteryTicket(Ball.getBalls(Arrays.asList(7, 8, 9, 10, 11, 30)));
