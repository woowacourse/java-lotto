...
public class LottoTicketResultTest {
	...
	void zeroMatch() {
		LottoTicket lotto = LottoTicket.byManual(List.of(10, 11, 12, 13, 14, 15));
	...
	void oneMatch() {
		LottoTicket lotto = LottoTicket.byManual(List.of(10, 11, 12, 13, 14, 6));
	...
	void twoMatch() {
		LottoTicket lotto = LottoTicket.byManual(List.of(10, 11, 12, 13, 5, 6));
	...
	void FIFTH_Match() {
		LottoTicket lotto = LottoTicket.byManual(List.of(1, 2, 3, 7, 8, 9));
	...
	void FOURTH_Match() {
		LottoTicket lotto = LottoTicket.byManual(List.of(1, 2, 3, 4, 8, 9));
	...
	void THIRD_Match() {
		LottoTicket lotto = LottoTicket.byManual(List.of(1, 2, 3, 4, 5, 9));
	...
	void SECOND_Match() {
		LottoTicket lotto = LottoTicket.byManual(List.of(1, 2, 3, 4, 5, 7));
	...
	void FIRST_Match() {
		LottoTicket lottoTicket = LottoTicket.byManual(List.of(1, 2, 3, 4, 5, 6));
