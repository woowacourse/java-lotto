...
public class LottosTest {
    ...
    void createLottos() {
        List<Lotto> lottos = List.of(lottoFactory.generateLotto(List.of(1, 2, 3, 4, 5, 6)));
    ...
    void calculateLottoMatchResult() {
        WinningLotto winningLotto = new WinningLotto(lottoFactory.generateLotto(
            List.of(1, 2, 3, 4, 5, 6)),
            LottoNumber.valueOf(7));

        Lottos lottos = new Lottos(List.of(lottoFactory.generateLotto(List.of(1, 2, 3, 4, 5, 6))));
