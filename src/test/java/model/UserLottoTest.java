...
class UserLottoTest {
    ...
    void purchaseLottoSuccess() {
        ...
        UserLotto userLotto = new UserLotto(new LottoNumberGenerator(), rawPurchaseAmount);
    ...
    void purchaseLottoFailure(String rawPurchaseAmount) {
        assertThrows(IllegalArgumentException.class, () -> new UserLotto(new LottoNumberGenerator(), rawPurchaseAmount));
    }
}