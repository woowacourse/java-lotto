...
class PrizeTest {
    ...
    void findFirstPrize() {
        ...
        assertThat(prizeWithTrue).isEqualTo(Prize.FIRST_PLACE);

        Prize prizeWithFalse = Prize.find(6, false);
        assertThat(prizeWithFalse).isEqualTo(Prize.FIRST_PLACE);
    }
    ...
    void findSecondPrize() {
        ...
        assertThat(prizeWithTrue).isEqualTo(Prize.SECOND_PLACE);
    }
    ...
    void findThirdPrize() {
        ...
        assertThat(prizeWithTrue).isEqualTo(Prize.THIRD_PLACE);
    }
    ...
    void findFourthPrize() {
        ...
        assertThat(prizeWithTrue).isEqualTo(Prize.FOUR_PLACE);

        Prize prizeWithFalse = Prize.find(4, false);
        assertThat(prizeWithFalse).isEqualTo(Prize.FOUR_PLACE);
    }
    ...
    void findFifthPrize() {
        ...
        assertThat(prizeWithTrue).isEqualTo(Prize.FIFTH_PLACE);

        Prize prizeWithFalse = Prize.find(3, false);
        assertThat(prizeWithFalse).isEqualTo(Prize.FIFTH_PLACE);
    }
    @Test
    @DisplayName("로또 번호 일치 갯수와 보너스 번호 일치 여부를 통해 Prize 를 잘 찾는 지 확인 : 꼴등")
    void findNonePrize() {
        Prize prizeWithTrue = Prize.find(2, true);
        assertThat(prizeWithTrue).isEqualTo(Prize.LAST_PLACE);

        Prize prizeWithFalse = Prize.find(1, false);
        assertThat(prizeWithFalse).isEqualTo(Prize.LAST_PLACE);
    }
}
