...
public class LottoMachineTest {
    ...
    void sumTotalLottoRankPrizeAmount() {
        LottoMachine lottoMachine = new LottoMachine(
            new LottoRankJudge(LottoNumbers.withSixNumbers(1, 2, 3, 4, 5, 6), 7));

        LottoResult lottoResult = lottoMachine
            .summarize(List.of(LottoNumbers.withSixNumbers(1, 2, 3, 4, 5, 6)));
