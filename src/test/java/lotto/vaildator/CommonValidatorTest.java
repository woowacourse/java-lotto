...
public class CommonValidatorTest {
    ...
    void 리스트_내에_중복되는_번호가_있으면_예외_발생() {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> CommonValidator.validateDuplication(List.of(1, 1, 2, 3, 4, 5)))
    ...
    void 리스트_내_숫자가_범위를_벗어난_경우_예외_발생(int invalidNumber) {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> CommonValidator.validateRange(List.of(1, 2, 3, 4, 5, invalidNumber), 1, 45))
    ...
    void 단일_숫자가_범위를_벗어난_경우_예외_발생(int invalidNumber) {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> CommonValidator.validateRange(invalidNumber, 1, 45))
                .withMessage(ExceptionMessage.OUT_OF_RANGE.getContent());
    }
    ...
    void 리스트_크기가_잘못된_경우_예외_발생() {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> CommonValidator.validateSize(List.of(1, 2, 3, 4, 5, 6, 7), 6))
