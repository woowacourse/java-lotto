...
class LottoGameTest {
    ...
    void buyManualLottosTest() {
        LottoGame lottoGame = new LottoGame(1000, 1);
        List<List<Integer>> rawManualLottos = List.of(List.of(1, 2, 3, 11, 12, 13));

        lottoGame.buyLottos(rawManualLottos, new TestAutoLottoFactory());
    ...
    void buyAutoLottosTest() {
        LottoGame lottoGame = new LottoGame(1000, 0);
        lottoGame.buyLottos(Collections.emptyList(), new TestAutoLottoFactory());
