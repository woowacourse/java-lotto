...
public class WinningStatisticsTest {
    ...
    void 수익률_계산_5등() {
        ...
        assertThat(WinningStatistics.of(lottoTickets, winningLotto).calculateROI()).isEqualTo(500);
    }
    ...
    void 수익률_계산_4등() {
        ...
        assertThat(WinningStatistics.of(lottoTickets, winningLotto).calculateROI()).isEqualTo(5000);
    }
    ...
    void 수익률_계산_3등() {
        ...
        assertThat(WinningStatistics.of(lottoTickets, winningLotto).calculateROI()).isEqualTo(150000);
    }
    ...
    void 수익률_계산_2등() {
        ...
        assertThat(WinningStatistics.of(lottoTickets, winningLotto).calculateROI()).isEqualTo(Long.valueOf(3000000L));
    }
    ...
    void 수익률_계산_1등() {
        ...
        assertThat(WinningStatistics.of(lottoTickets, winningLotto).calculateROI()).isEqualTo(200000000L);
    }
}
