...
class LottoTicketsTest {
    ...
    private final TicketNumbersDto ticketNumbersDto = new TicketNumbersDto(Arrays.asList(1, 2, 3, 4, 5, 6));
    ...
    void makeManualLottoTickets() {
        List<TicketNumbersDto> ticketNumbersDtos = Arrays.asList(ticketNumbersDto, ticketNumbersDto);
        LottoTickets lottoTickets = LottoTickets.generate(ticketNumbersDtos, 0, lottoNumberGenerator);
    ...
    void getTicketCounts() {
        List<TicketNumbersDto> ticketNumbersDtos = Arrays.asList(ticketNumbersDto, ticketNumbersDto);
        LottoTickets lottoTickets = LottoTickets.generate(ticketNumbersDtos, 3, lottoNumberGenerator);
