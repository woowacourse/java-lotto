...
class LottoTicketsTest {
    ...
    void makeManualLottoTickets() {
        LottoTickets lottoTickets = LottoTickets.generateManual(Arrays.asList(ticketNumbersDto, ticketNumbersDto));
    ...
    @Test
    void concat() {
        LottoTickets manualLottoTickets = LottoTickets.generateManual(Arrays.asList(ticketNumbersDto, ticketNumbersDto));
