...
public class LottoRankingTest {
    ...
    class Of {
        ...
        class Context_with_count_and_contain_bonus {
            ...
            void it_create_ok(int count, boolean containBonus, LottoRanking expected) {
                LottoRanking lottoRanking = LottoRanking.of(count, containBonus);

                Assertions.assertThat(lottoRanking).isEqualTo(expected);
            }
        }
    }
}
