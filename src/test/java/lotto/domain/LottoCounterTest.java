...
public class LottoCounterTest {
    ...
    void checkManualLottoCountNegativeNumber() {
        Assertions.assertThatThrownBy(() -> new LottoCounter(new Money(10000), -1))
    ...
    void checkManualLottoCountOverMoney() {
        Assertions.assertThatThrownBy(() -> new LottoCounter(new Money(10000), 11))
                .isInstanceOf(LottoCounterException.class)
    ...
    void calculateAutoLottoCount() {
        LottoCounter lottoCounter = new LottoCounter(new Money(10000), 3);
