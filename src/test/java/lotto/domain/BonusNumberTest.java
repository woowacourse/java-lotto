...
public class BonusNumberTest {
    ...
    void Number_In_Range(int value) {
        assertThatThrownBy(() -> new BonusNumber(value, new Lotto())).isInstanceOf(
    ...
    void Duplicate_Number_Exist() {
        assertThatThrownBy(() -> {
            new BonusNumber(5, new Lotto(Arrays.asList(1, 3, 5, 7, 9, 11)));
        }).isInstanceOf(
                IllegalArgumentException.class);
    }
    ...
    void Bonus_Number_Generation_Test() {
        int inputValue = 5;
        BonusNumber bonusNumber = new BonusNumber(inputValue, new Lotto(Arrays.asList(1, 2, 3, 4, 6, 7)));
