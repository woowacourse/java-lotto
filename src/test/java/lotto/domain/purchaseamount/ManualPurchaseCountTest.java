...
class ManualPurchaseCountTest {
    private final PurchaseAmount purchaseAmount = PurchaseAmount.fromPurchaseAmountAndLottoPrice("14000");
    ...
    void create_exceptionByNotZeroOrNaturalNumber_Test(final String invalidValue) {
        //when then
        assertThatThrownBy(() -> new ManualPurchaseCount(invalidValue, purchaseAmount))
    ...
    void create_exceptionByLowerTest() {
        ...
        //when then
        assertThatThrownBy(() -> new ManualPurchaseCount(higherManualPurchaseCountThanTotalCount, purchaseAmount))
                .isInstanceOf(IllegalArgumentException.class)
