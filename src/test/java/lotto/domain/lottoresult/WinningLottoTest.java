...
public class WinningLottoTest {
    LottoTicket winningTicket = LottoTicket.create("1, 2, 3, 4, 5, 6");

    @Test
    void 숫자아닌_보너스번호() {
        assertThrows(InvalidLottoNumberException.class, () -> {
            WinningLotto.create(winningTicket, "a");
        });
    }
    ...
    void 범위벗어난_보너스번호() {
        assertThrows(InvalidLottoNumberException.class, () -> {
            WinningLotto.create(winningTicket, "46");
        });
    }
    ...
    void 중복된_보너스번호() {
        assertThrows(InvalidWinningLottoException.class, () -> {
            WinningLotto.create(winningTicket, "1");
        });
    }
