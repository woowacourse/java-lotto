...
class RankTest {
    ...
    void findRank_If_Win(int winningNumbersMatchCount, boolean bonusNumberMatch, String rankName) {
    ...
    void findRank_If_Lose(int winningNumbersMatchCount, boolean bonusNumberMatch) {
        Assertions.assertThat(Rank.findRank(winningNumbersMatchCount, bonusNumberMatch))
