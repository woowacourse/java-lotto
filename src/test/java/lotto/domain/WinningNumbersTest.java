...
public class WinningNumbersTest {
    ...
    void generateWinningNumbersByString(String bonusNumber) {
        Assertions.assertThatThrownBy(() -> WinningNumbers.generateWinningNumbersByString("1,2,3,4,5,6", bonusNumber))
