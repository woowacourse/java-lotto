...
public class IncludingBonusBallConditionTest {
	...
	@ParameterizedTest
	@EnumSource(value = IncludingBonusBallCondition.class, names = {"NO_MATTER", "INCLUDE"})
	...
	@ParameterizedTest
	@EnumSource(value = IncludingBonusBallCondition.class, names = {"NO_MATTER", "NONE_INCLUDE"})
