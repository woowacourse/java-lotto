...
public class ChoiceNumberTest {
    ...
    void No_6_Input_Numbers(List<Integer> inputValues) {
        assertThatThrownBy(() -> new ChoiceNumber(inputValues)).isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void All_Numbers_In_Range() {
        assertThatThrownBy(() -> new ChoiceNumber(Arrays.asList(0, 2, 3, 4, 5, 6))).isInstanceOf(
    ...
    void Duplicate_Number_Exist() {
        assertThatThrownBy(() -> new ChoiceNumber(Arrays.asList(1, 1, 3, 4, 5, 6))).isInstanceOf(
                IllegalArgumentException.class);
    }
    ...
    void Count_Same_Number(List<Integer> inputValue, int correctNumber) {
        ChoiceNumber choiceNumber = new ChoiceNumber(Arrays.asList(1, 2, 3, 4, 5, 6));
        ChoiceNumber comparisonNumber = new ChoiceNumber(inputValue);
