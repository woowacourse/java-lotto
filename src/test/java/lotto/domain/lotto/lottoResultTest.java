...
public class lottoResultTest {
    ...
    void 매칭_테스트() {
        ...
        LottoResultVO lottoResult_vo = new LottoResultVO(new LottoResult(ticket, winningLotto).matchLotto(), price);
    ...
    private static double sum(LottoResultVO lottoResult) {
