...
public class LotteriesTest {
    ...
    void addLottoByTicket() {
        final Lotteries lotteries = new Lotteries(new RandomLottoMachine(), 5);
    ...
    void compareLottoByTicket() {
        ...
        final Lotteries lotteries = new Lotteries(() -> expected, 5);
    ...
    void scratchLottoCheck() {
        ...
        final Lotteries lotteries = new Lotteries(() -> Arrays.asList(1, 2, 3, 4, 5, 6),
            ticket.getTotalCount());
