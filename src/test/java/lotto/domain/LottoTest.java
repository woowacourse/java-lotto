...
public class LottoTest {
    ...
    void validateNoDuplication() {
        assertThrows(DuplicatedLottoNumbersException.class, () ->
                Lotto.create(new ManualLottoNumbersGenerator(Arrays.asList(1, 1, 3, 4, 5, 6))));
    }

    @Test
    void validateNumOfLottoNumbers() {
        assertThrows(InvalidSizeOfLottoNumbersException.class, () ->
                Lotto.create(new ManualLottoNumbersGenerator(Arrays.asList(1, 2, 3, 4, 5))));
    }

    @Test
    void containTest() {
        Lotto lotto = Lotto.create(new ManualLottoNumbersGenerator(Arrays.asList(1, 2, 3, 4, 5, 6)));
    ...
    void countMatchesTest() {
        Lotto lotto = Lotto.create(new ManualLottoNumbersGenerator(Arrays.asList(1, 2, 3, 4, 5, 6)));
        assertThat(lotto.countMatches(Lotto.create(new ManualLottoNumbersGenerator(Arrays.asList(1, 2, 3, 4, 5, 6))))).isEqualTo(6);
        assertThat(lotto.countMatches(Lotto.create(new ManualLottoNumbersGenerator(Arrays.asList(1, 2, 3, 4, 5, 7))))).isEqualTo(5);
    }
