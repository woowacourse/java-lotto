...
public class WinStatisticsTest {
    ...
    void 수익률_계산하기() {
        List<LottoTicket> lottoTickets = Arrays.asList(
                new LottoTicketFactory().create("1,2,3,4,5,7"), new LottoTicketFactory().create("1,3,4,7,10,11"),
                new LottoTicketFactory().create("1,3,4,20,21,22"), new LottoTicketFactory().create("1,2,5,7,16,22"));
