...
public class LottoRankingsTest {
    ...
    class Of {
        ...
        class Context_with_count_and_contain_bonus {
            ...
            void it_create_ok(int count, boolean containBonus, LottoRankings expected) {
                LottoRankings lottoRankings = LottoRankings.of(count, containBonus);

                Assertions.assertThat(lottoRankings).isEqualTo(expected);
            }
        }
    }
}
